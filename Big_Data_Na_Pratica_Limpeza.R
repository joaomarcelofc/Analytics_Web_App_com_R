# Big Data na Prática 2 - Analytics Web App Para Grandes Volumes de Dados: 
# Como o PIB e a Desigualdade Social Influenciam no Crescimento da Netflix?

setwd("C:/JoaoMarcelo/FCD/BigDataRAzure/Cap04")
getwd()
...
# Carregando os dados de assinantes da Netflix em Julho/2021
